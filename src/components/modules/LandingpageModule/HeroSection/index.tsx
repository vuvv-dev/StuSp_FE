        ...
        >
          <motion.div className="flex flex-col items-center">
            ...
            >
              ...
              <p className="mb-3 w-2/3 text-center text-xs font-medium sm:mb-4 sm:text-base sm:leading-4 md:mb-5 md:w-1/2 md:text-lg md:leading-6 lg:mb-8 lg:text-xl lg:leading-7 xl:leading-8">
                StuSp - Môi trường nơi bạn có thể kết nối và tham gia vào các
          ...
          <div className="">
            ...
            >
              ...
              {/* <Cat1 /> */}
              <div className="absolute bottom-2 left-1/2 -z-10 hidden h-10 w-28 -translate-x-1/2 rounded-full bg-black/30 blur-md lg:block"></div>
