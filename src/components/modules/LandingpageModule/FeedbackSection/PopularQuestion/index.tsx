...
const faqData = [
  {
    id: "item-1",
    question: "StuSp là gì?",
    answer:
      "StuSp - Future Unified Study Environment là một nền tảng trực tuyến cho phép người dùng kết nối, tham gia vào các phòng học, và ôn thi trực tuyến. Chúng tôi cung cấp một môi trường học tập toàn diện với nhiều tài nguyên giáo dục và công cụ hỗ trợ học tập.",
  },
  {
    id: "item-2",
    question: "StuSp có miễn phí không?",
    answer:
      "StuSp cung cấp cả dịch vụ miễn phí và trả phí. Gói miễn phí bao gồm các tính năng cơ bản, trong khi gói trả phí cung cấp nhiều tính năng nâng cao hơn như tài liệu ôn thi chi tiết và truy cập vào các lớp học đặc biệt.",
  },
  {
    id: "item-3",
    question: "Làm thế nào để đăng ký tài khoản trên StuSp?",
    answer:
  ...
  {
    id: "item-5",
    question: "Làm thế nào để sử dụng tài liệu ôn thi trên StuSp?",
    answer:
      'Tài liệu ôn thi có sẵn trong phần "Ôn thi" của StuSp. Bạn có thể tải xuống hoặc xem trực tuyến. Đối với một số tài liệu nâng cao, bạn có thể cần nâng cấp tài khoản của mình.',
  },
];
